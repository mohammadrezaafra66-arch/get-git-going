...
| | |
|---|---|
| اشیایی که `anon` روی آن‌ها گرنتی دارد | **۲۱۱** |
| — جدول با `SELECT` | ۲۰۲ |
| — view با `SELECT` | ۷ |
...
1. **دامنه.** ۲۱۱ شیء گرنت `anon` دارند. باطل‌کردن همه‌شان روی ۵ شیء اثر
...
9. **شیر بسته است ولی اشیای موجود قدیمی‌اند.** پس از مهاجرت ۳۷۳، هر شیء تازه‌ای
   بدون گرنت `anon` متولد می‌شود. یعنی این ۲۱۱ عدد **دیگر رشد نمی‌کند** — یک
