-- 366-down.sql — restore asan_list_journal_export to the body live immediately before 366.
-- Captured 2026-08-19 via pg_get_functiondef. Identity arguments: date, date, text.
