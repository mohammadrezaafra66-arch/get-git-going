-- Down for 556: remove is_quick_price_only, restore get_sales_search_products
-- to the 130 definition, and restore sale_price_type enqueue trigger to 554.

SET client_encoding = 'UTF8';

-- Restore enqueue trigger from 554 (without quick-price-only skip)
...
-- Restore RPC from 20260722111653_130_sales_search_stock_sort.sql
...
ALTER TABLE public.sale_price_types DROP COLUMN IF EXISTS is_quick_price_only;
