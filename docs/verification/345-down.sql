-- 345-down.sql -- rollback for migration 345
-- Restores the three ledger writers to their pre-345 bodies, i.e. WITHOUT doc_kind.
-- WARNING: while journal_entries.doc_kind is NOT NULL (migration 341), these restored
-- bodies FAIL with 23502. Only run this after rolling 341 back, or together with it.
