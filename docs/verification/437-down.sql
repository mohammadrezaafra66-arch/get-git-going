...
-- 437-down — restore person_create_inline to its migration 414 definition.
-- Captured from the live test database on 2026-09-05 BEFORE 437 was applied;
-- verified byte-identical to supabase/migrations/20260829120000_414_every_person_is_a_customer.sql.
-- Applying this file removes the Asan-identifier registration and returns
-- p_accounting_code to writing the mirror columns only.
