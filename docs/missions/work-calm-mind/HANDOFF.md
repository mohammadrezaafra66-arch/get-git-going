...
| Docs (this handoff cycle) | `docs/research/work-calm-mind/README.md`, `PROGRESS.md` (one history row), this file | written 2026-09-16 by docs-writer |
...
- Production apply of migration 543 (p1-data applied on LAN copy only — `checkpoints/p1-data.md:6`, `:63`).
...
- `viewer` has DB `role_permissions` view/create/update for module `work` but is outside FE route gate (`…543.sql:23-25` vs `_app.operations.work.tsx:5`).
