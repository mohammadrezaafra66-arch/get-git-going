...
-- ============================================================================
-- REVERT 577 - restore create_sales_quote_with_items without p_interaction_id
-- ============================================================================
-- Source: docs/missions/salesdesk-9-fixes/evidence/FIX/create_sales_quote_with_items-live-pre577.txt
-- ============================================================================
...
REVOKE ALL ON FUNCTION public.create_sales_quote_with_items(p_customer_name text, p_customer_phone text, p_customer_note text, p_expires_at timestamp with time zone, p_subtotal_amount numeric, p_discount_amount numeric, p_final_amount numeric, p_items jsonb, p_settlement_type_id uuid, p_customer_id uuid, p_below_list_ack boolean, p_deposit_amount numeric, p_commitment_confirmed boolean, p_visitor_id uuid, p_warehouse_id uuid, p_quote_exception_type text, p_quote_exception_minutes integer, p_quote_exception_amount numeric, p_quote_exception_text text) FROM anon;
GRANT EXECUTE ON FUNCTION public.create_sales_quote_with_items(p_customer_name text, p_customer_phone text, p_customer_note text, p_expires_at timestamp with time zone, p_subtotal_amount numeric, p_discount_amount numeric, p_final_amount numeric, p_items jsonb, p_settlement_type_id uuid, p_customer_id uuid, p_below_list_ack boolean, p_deposit_amount numeric, p_commitment_confirmed boolean, p_visitor_id uuid, p_warehouse_id uuid, p_quote_exception_type text, p_quote_exception_minutes integer, p_quote_exception_amount numeric, p_quote_exception_text text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.create_sales_quote_with_items(p_customer_name text, p_customer_phone text, p_customer_note text, p_expires_at timestamp with time zone, p_subtotal_amount numeric, p_discount_amount numeric, p_final_amount numeric, p_items jsonb, p_settlement_type_id uuid, p_customer_id uuid, p_below_list_ack boolean, p_deposit_amount numeric, p_commitment_confirmed boolean, p_visitor_id uuid, p_warehouse_id uuid, p_quote_exception_type text, p_quote_exception_minutes integer, p_quote_exception_amount numeric, p_quote_exception_text text) TO service_role;
