...
| G-06 | قرارداد Control Plane و Worker چیست؟ | `openapi/automation-v1.yaml`. | محمدرضا افرا | endpointهای heartbeat، claim، events، run status تعریف شوند. | endpoint اختصاصی هر ربات واقعی در فاز صفر. | `openapi/automation-v1.yaml` |
