-- ROLLBACK for migration 420. This is the EXACT definition of
-- create_sales_quote_with_items as it stood BEFORE 420, captured with pg_get_functiondef
-- on the test database (afrakala) on 2026-09-03. Running this file restores it.
--
-- 420 changes ONE thing in this body: the p_customer_id IS NULL branch accepted only
-- 'accounting_approval'; it now also accepts 'guest_no_link'. Nothing else differs.
