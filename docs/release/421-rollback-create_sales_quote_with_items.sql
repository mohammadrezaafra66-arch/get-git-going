-- ROLLBACK for migration 421. Exact pg_get_functiondef output taken AFTER 420 and
-- BEFORE 421, on the test database, 2026-09-03. Running this file restores it.
-- 421 changes ONE string: the guest branch's RAISE message. Nothing else differs.
