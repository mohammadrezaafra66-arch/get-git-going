...
**Phase Label:** PHASE-1  
**Status:** PARTIAL — Packets 1.1 to 1.4 accepted; Packet 1.5 ready for review; later packets locked  
**Owner:** محمدرضا افرا
...
| **1.5** | TPC-1-005 — Torob Limited Implementation Design | PHASE-1 | READY FOR REVIEW | [TPC-1-005](./task-packets/TPC-1-005-torob-limited-implementation-design.md) | [Packet 1.4 acceptance](../baseline/PHASE1_PACKET_1_4_ACCEPTANCE_2026_06_07.md) |
| **1.6** | TBD — Torob limited execution | PHASE-1 | LOCKED | _not created_ | 1.5 |
...
Packet 1.5 designs the Torob limited implementation packet only; it does not implement Torob limited.
...
- [Packet 1.4 acceptance](../baseline/PHASE1_PACKET_1_4_ACCEPTANCE_2026_06_07.md)
