...
**Phase Label:** PHASE-1  
**Status:** PARTIAL — Packet 1.1 accepted; Packet 1.2 ready for review; later packets locked  
**Owner:** محمدرضا افرا
...
| **1.2** | TPC-1-002 — Phase 1 Scope Lock | PHASE-1 | READY FOR REVIEW | [TPC-1-002](./task-packets/TPC-1-002-phase1-scope-lock.md) | [Packet 1.1 acceptance](../baseline/PHASE1_PACKET_1_1_ACCEPTANCE_2026_06_07.md) |
| **1.3** | TBD — Worker Runtime boundary | PHASE-1 | LOCKED | _not created_ | 1.2 |
| **1.4** | TBD — Plugin / Driver SDK boundary | PHASE-1 | LOCKED | _not created_ | Prior packets |
| **1.5** | TBD — Torob limited implementation packet design | PHASE-1 | LOCKED | _not created_ | Prior packets |
...
Packet 1.2 locks the Phase 1 scope before any Worker Runtime, Driver, database, API, or UI implementation.
