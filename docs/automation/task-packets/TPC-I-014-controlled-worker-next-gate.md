# TPC-I-014 — Controlled Worker Next Gate
...
Define the next governance gate after TPC-I-013 implementation and local test evidence were merged.
...
TPC-I-013 worker-runtime tests = passed
...
TPC-I-014 may define only the next governance boundary.
...
A future packet may consider only a controlled Worker Runtime follow-up step.
...
Only after this packet is accepted, the next PR may define a separate concrete packet for the next controlled Worker Runtime follow-up step.
...
```text
TPC-I-014 may define the next controlled Worker boundary gate.
