...
| فاز جاری | **۲.۱ و ۲.۱b و ۲.۲ کامل** · ۲.۳ و gate باقی |
| مهاجرت‌های اعمال‌شده در این برنامه | ۳۰۳، ۳۰۴، ۳۰۵، ۳۰۶، ۳۰۷، ۳۰۸، ۳۰۹ |
...
**اقدام بعدی:** P2.3 — چک‌لیست `docs/asan/supplier-asan-codes-to-fill.md` و بنر
فارسی روی `/suppliers`. شمارش **زنده**، هیچ عدد ثابتی.

**سپس:** P2 gate (typecheck ۷۰، e2e کامل، استقرار با تطابق سه سیگنال) →
**توقف** برای تصمیم‌های مالک.
