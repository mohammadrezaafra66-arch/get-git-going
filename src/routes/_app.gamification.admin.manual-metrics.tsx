...
import { AlertTriangle, BookOpenCheck, Loader2, Save } from "lucide-react";
    ...
    <div className="space-y-1">
      ...
      <div className="flex items-center gap-2">
        <Input
          ...
          value={
            money && form[key]
              ? Number(num(form[key])).toLocaleString("en-US")
              : form[key]
          }
          onChange={(e) =>
      ...
      <Card className="border-primary/20 bg-primary/5">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-base">
            ...
            آموزش ساده ثبت عملکرد روزانه
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4 text-sm leading-7 text-foreground">
          <p>
            این صفحه برای زمانی است که می‌خواهیم عملکرد واقعی هر کارشناس را به صورت دستی
            وارد کنیم؛ مثلا امروز هر کارشناس چقدر فروخته، چقدر سود ساخته، چند تماس ورودی
            و خروجی داشته و مجموع مکالمه‌هایش چند دقیقه بوده است.
          </p>

          <div className="grid gap-3 lg:grid-cols-2">
            <div className="rounded-md border bg-background/80 p-3">
              <div className="mb-2 font-medium">مراحل ثبت</div>
              <ol className="list-decimal space-y-1 pr-5">
                <li>اول نام کارشناس را از قسمت «کارشناس» انتخاب کنید.</li>
                <li>بعد تاریخ همان روزی را انتخاب کنید که آمارش را می‌خواهید ثبت کنید.</li>
                <li>مبلغ فروش را به تومان وارد کنید؛ یعنی جمع فروش همان کارشناس در همان روز.</li>
                <li>مبلغ سود را به تومان وارد کنید؛ یعنی سود ایجادشده از همان فروش‌ها.</li>
                <li>تعداد تماس‌های ورودی و خروجی را جداگانه وارد کنید.</li>
                <li>مجموع دقیقه‌های مکالمه را وارد کنید؛ مثلا اگر چند تماس جمعا ۴۵ دقیقه بوده، عدد ۴۵ را بزنید.</li>
                <li>در صورت نیاز توضیح کوتاه بنویسید و در پایان روی «ثبت و به‌روزرسانی امتیاز» بزنید.</li>
              </ol>
            </div>

            <div className="rounded-md border bg-background/80 p-3">
              <div className="mb-2 font-medium">قوانین مهم</div>
              <ul className="list-disc space-y-1 pr-5">
                <li>هر کارشناس برای هر تاریخ فقط یک رکورد دارد؛ اگر دوباره همان تاریخ را ثبت کنید، همان رکورد قبلی ویرایش می‌شود.</li>
                <li>کاربر عادی فقط تا ۵ روز گذشته را می‌تواند ثبت یا اصلاح کند.</li>
                <li>برای تاریخ آینده امکان ثبت وجود ندارد.</li>
                <li>عددها نباید منفی باشند. اگر اطلاعاتی ندارید، همان فیلد را صفر بگذارید.</li>
                <li>بعد از ثبت، رکورد در جدول «رکوردهای اخیر» نمایش داده می‌شود و درخواست به‌روزرسانی امتیاز همان کارشناس ارسال می‌شود.</li>
              </ul>
            </div>
          </div>

          <div className="rounded-md border border-amber-500/30 bg-amber-50 p-3 text-amber-900 dark:bg-amber-950/20 dark:text-amber-100">
            <div className="font-medium">اگر بعد از ثبت، لیدربرد تغییر نکرد چه معنی دارد؟</div>
            <p className="mt-1">
              ثبت اطلاعات یعنی داده روزانه ذخیره شده است. دیده شدن اثر آن در امتیاز و لیدربرد
              به فعال بودن قوانین امتیازدهی و وزن‌های مربوط به فروش، سود، تماس‌ها و دقایق
              مکالمه بستگی دارد. اگر قوانین یا وزن‌ها هنوز کامل فعال نشده باشند، رکورد ذخیره
              می‌شود ولی عدد لیدربرد ممکن است تغییر نکند.
            </p>
          </div>
        </CardContent>
      </Card>
            ...
            <div className="space-y-1">
              ...
              <div className="flex flex-wrap items-center gap-2 pt-1">
                {isFuture ? (
                  ...
                  <Badge
                    variant={isAdmin ? "secondary" : "destructive"}
                    className="text-[10px]"
                  >
                    {isAdmin
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex justify-end">
            <Button
              onClick={() => save.mutate()}
              disabled={locked || !staffId || save.isPending}
            >
              {save.isPending ? (
