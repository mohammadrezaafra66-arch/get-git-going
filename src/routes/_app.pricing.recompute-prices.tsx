              ...
              <Popover>
                ...
                <PopoverContent align="end" className="w-80 text-sm leading-6" dir="rtl">
                  <div className="space-y-2">
                    <div className="font-semibold">مسیر عادی خودکار است</div>
                    <p className="text-muted-foreground">
                      با تغییر قیمت خرید، نرخ ارز، قانون قیمت، حمل، نوع تسویه یا نوع قیمت فروش،
                      سیستم خودش صف بازمحاسبه را پر می‌کند و worker قیمت را منتشر می‌کند. برای
                      کار روزمره نیازی به این دکمه نیست.
                    </p>
                    <div>
                      <div className="font-medium">از این دکمه فقط وقتی استفاده کن:</div>
                      <ul className="list-disc ps-5 space-y-1 text-muted-foreground">
                        <li>بازیابی اضطراری وقتی صف گیر کرده یا worker متوقف بوده است.</li>
                        <li>بعد از import یا اصلاح گسترده که می‌خواهی همه را یک‌جا دوباره بنویسی.</li>
                        <li>راه‌اندازی اولیه / بعد از migration وقتی هنوز قیمت فروش دیده نمی‌شود.</li>
                      </ul>
                    </div>
                    <div>
                      <div className="font-medium">استفاده نکن وقتی:</div>
                      <ul className="list-disc ps-5 space-y-1 text-muted-foreground">
                        <li>فقط قیمت خرید یک محصول عوض شده — همان یکی خودکار منتشر می‌شود.</li>
                        <li>فقط می‌خواهی یک کالا را اصلاح کنی.</li>
                      </ul>
                    </div>
                    <p className="text-xs text-muted-foreground">
                      اجرای دسته‌ای ممکن است قیمت چندین محصول را هم‌زمان بازنویسی کند؛ برای یک
                      کالا از مسیر تک‌محصول یا صبر برای worker استفاده کن.
                    </p>
                  </div>
                </PopoverContent>
              </Popover>
