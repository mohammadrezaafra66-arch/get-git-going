...
function PendingUsersPage() {
  ...
  const queryKey = useMemo(() => ["pending-users", status, debounced, page] as const, [status, debounced, page]);
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="مدیریت ثبت‌نام‌های جدید: تأیید، رد یا غیرفعال‌سازی کاربران."
      />
