...
// NOTE: `check_and_update_mission_progress_for_employee` is invoked
// automatically by the AFTER INSERT trigger on `employee_score_events`.
// EXECUTE is revoked from anon/authenticated/public, so a frontend wrapper
