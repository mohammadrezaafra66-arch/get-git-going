...
const NAVIGATION_SEEDS = [
  ...
  {
    to: "/torob-ops/settings",
    label: "تنظیمات عملیات ترب",
    icon: ShieldCheck,
    module: "torob-ops",
    group: "main",
    hiddenFromMenu: true,
  ...
  {
    to: "/torob-ops/history",
    label: "تاریخچه قیمت ترب",
    icon: TrendingUp,
    module: "torob-ops",
    group: "main",
    hiddenFromMenu: true,
  ...
  {
    to: "/admin/torob-ops-access",
    label: "دسترسی عملیات ترب",
    icon: KeyRound,
    module: "torob-ops",
    group: "admin",
    adminOnly: true,
...
const ROLE_ALLOWLIST_BY_ROUTE: Record<string, AppRole[]> = {
  ...
  "/torob-ops": ["admin", "manager", "sales", "accountant", "viewer"],
  "/torob-ops/runs": ["admin", "manager", "sales", "accountant", "viewer"],
  "/torob-ops/findings": ["admin", "manager", "sales", "accountant", "viewer"],
  "/torob-ops/shops": ["admin", "manager", "sales", "accountant", "viewer"],
  "/torob-ops/accounts": ["admin"],
  "/torob-ops/settings": ["admin"],
  "/torob-ops/history": ["admin", "manager", "sales", "accountant", "viewer"],
  ...
  "/operations/work/settings": ["admin", "manager"],
