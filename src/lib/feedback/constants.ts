...
export const FEEDBACK_TYPE_LABELS: Record<FeedbackType, string> = FEEDBACK_TYPES.reduce(
  (a, t) => ({ ...a, [t.value]: t.label }),
...
export const FEEDBACK_STATUS_LABELS: Record<FeedbackStatus, string> = FEEDBACK_STATUSES.reduce(
  (a, s) => ({ ...a, [s.value]: s.label }),
  {} as Record<FeedbackStatus, string>,
);

export const FEEDBACK_STATUS_COLORS: Record<FeedbackStatus, string> = FEEDBACK_STATUSES.reduce(
  (a, s) => ({ ...a, [s.value]: s.color }),
  {} as Record<FeedbackStatus, string>,
);
