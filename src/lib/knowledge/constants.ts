...
export const KNOWLEDGE_CATEGORY_LABELS: Record<KnowledgeCategory, string> = Object.fromEntries(
...
export const KNOWLEDGE_ACCESS_LABELS: Record<KnowledgeAccessLevel, string> = Object.fromEntries(
  KNOWLEDGE_ACCESS_LEVELS.map((l) => [l.value, l.label]),
) as Record<KnowledgeAccessLevel, string>;
