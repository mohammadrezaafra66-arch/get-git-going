...
import {
  useReviewDeliveryReceipt,
  type DeliveryReceiptRow,
} from "@/hooks/delivery-receipts/useDeliveryReceipts";

export function DeliveryReceiptReviewActions({
  receipt,
}: {
  receipt: DeliveryReceiptRow;
}) {
  const { roles } = useAuth();
  const mutation = useReviewDeliveryReceipt();
  ...
  if (receipt.status !== "pending_review") return null;
    ...
    <div className="flex gap-2" dir="rtl">
      ...
      >
        ...
        <AlertDialogContent dir="rtl">
          <AlertDialogHeader>
            <AlertDialogTitle>تأیید رسید</AlertDialogTitle>
            <AlertDialogDescription>
              این رسید به‌عنوان «تأیید شد» ثبت خواهد شد. در صورت تمایل یادداشت اضافه
              کنید.
            </AlertDialogDescription>
          </AlertDialogHeader>
      ...
      >
        ...
        <AlertDialogContent dir="rtl">
          <AlertDialogHeader>
            <AlertDialogTitle>رد رسید</AlertDialogTitle>
            <AlertDialogDescription>
              این رسید به‌عنوان «رد شد» ثبت خواهد شد. در صورت تمایل دلیل را وارد کنید.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <div className="space-y-2">
            <Label>یادداشت (اختیاری)</Label>
