...
export const NAV_ITEMS: NavItem[] = [
  ...
  { to: "/products/new", label: "افزودن محصول", icon: Plus, module: "products", group: "products-pricing", subgroup: "pp-catalog" },
  { to: "/products/categories", label: "دسته‌بندی‌ها", icon: Layers, module: "products", group: "products-pricing", subgroup: "pp-catalog" },
  { to: "/products/brands", label: "برندها", icon: Bookmark, module: "products", group: "products-pricing", subgroup: "pp-catalog" },
  { to: "/products/attributes", label: "ویژگی‌ها", icon: Tag, module: "products", group: "products-pricing", subgroup: "pp-catalog" },
  { to: "/products/labels", label: "برچسب‌ها", icon: Tag, module: "products", group: "products-pricing", subgroup: "pp-catalog" },
  { to: "/pricing/purchase-prices", label: "قیمت‌های خرید", icon: ShoppingBag, module: "pricing", group: "products-pricing", subgroup: "pp-pricing" },
  { to: "/pricing/rules", label: "قوانین قیمت‌گذاری", icon: Workflow, module: "pricing", group: "products-pricing", subgroup: "pp-pricing" },
  { to: "/pricing/sale-price-types", label: "نوع‌های قیمت فروش", icon: DollarSign, module: "pricing", group: "products-pricing", subgroup: "pp-pricing" },
  ...
  { to: "/pricing/amin-hozoor-board", label: "تابلو قیمت زنده", icon: Monitor, module: "pricing", group: "products-pricing", subgroup: "pp-publish" },
  { to: "/price-lists", label: "لیست قیمت زنده", icon: ListOrdered, module: "price-lists", group: "products-pricing", subgroup: "pp-publish" },
  { to: "/pricing/sale-lists", label: "لیست قیمت فروش", icon: FileText, module: "pricing", group: "products-pricing", subgroup: "pp-publish" },
  { to: "/pricing/recompute-prices", label: "انتشار دسته‌ای قیمت", icon: Sparkles, module: "pricing", group: "products-pricing", subgroup: "pp-publish", adminOnly: true },
  ...
  // ۴) فروش و مشتریان
  { to: "/sales", label: "جستجوی سریع فروش", icon: ShoppingCart, module: "sales", group: "sales-customers", subgroup: "sc-sales" },
  { to: "/sales/quotes", label: "پیش‌فاکتورها", icon: FileText, module: "invoices", group: "sales-customers", subgroup: "sc-sales" },
  { to: "/sales/invoices", label: "فاکتورهای فروش", icon: Receipt, module: "invoices", group: "sales-customers", subgroup: "sc-sales" },
  ...
  // ۹) مدیریت سیستم
  { to: "/users", label: "کاربران", icon: Users, module: "users", group: "admin", subgroup: "adm-users" },
  { to: "/users/pending", label: "کاربران در انتظار تأیید", icon: Users, module: "users", group: "admin", subgroup: "adm-users", adminOnly: true },
  { to: "/roles", label: "نقش‌ها و دسترسی‌ها", icon: ShieldCheck, module: "roles", group: "admin", subgroup: "adm-users" },
  { to: "/admin/roles", label: "مجوزهای پویا", icon: ShieldCheck, module: "roles", group: "admin", subgroup: "adm-users", adminOnly: true },
  { to: "/admin/profile-fields", label: "فیلدهای کاربر", icon: UserSquare2, module: "users", group: "admin", subgroup: "adm-users", adminOnly: true },
  { to: "/admin/settings", label: "تنظیمات عمومی", icon: Settings, module: "roles", group: "admin", subgroup: "adm-settings", adminOnly: true },
  { to: "/admin/marketing-channels", label: "کانال‌های تبلیغاتی", icon: Megaphone, module: "roles", group: "admin", subgroup: "adm-settings", adminOnly: true },
  { to: "/admin/payment-terms", label: "زمان‌های تسویه", icon: Wallet, module: "roles", group: "admin", subgroup: "adm-settings", adminOnly: true },
  { to: "/admin/waybill-fields", label: "فیلدهای بیجک", icon: Settings, module: "roles", group: "admin", subgroup: "adm-settings", adminOnly: true },
  { to: "/admin/receipt-fields", label: "فیلدهای فیش واریزی", icon: Settings, module: "roles", group: "admin", subgroup: "adm-settings", adminOnly: true },
  { to: "/admin/recent-purchase-settings", label: "وضعیت موجودی پس از خرید", icon: Settings, module: "roles", group: "admin", subgroup: "adm-settings", adminOnly: true },
  { to: "/admin/workflow-stages", label: "مراحل گردش‌کار", icon: Workflow, module: "roles", group: "admin", subgroup: "adm-settings", adminOnly: true },
  { to: "/admin/validation-rules", label: "قوانین اعتبارسنجی", icon: ShieldCheck, module: "roles", group: "admin", subgroup: "adm-settings", adminOnly: true },
  { to: "/pricing/currencies", label: "ارزها", icon: DollarSign, module: "pricing", group: "admin", subgroup: "adm-settings", adminOnly: true },
  { to: "/pricing/currency-sources", label: "منابع ارز", icon: DollarSign, module: "pricing", group: "admin", subgroup: "adm-settings", adminOnly: true },
  { to: "/pricing/currency-rates", label: "نرخ ارز", icon: DollarSign, module: "pricing", group: "admin", subgroup: "adm-settings", adminOnly: true },
  { to: "/pricing/market-rates-workshop", label: "کارگاه نرخ ارز و طلا", icon: Coins, module: "market-rates", group: "admin", subgroup: "adm-settings", adminOnly: true },
  { to: "/pricing/settlement-types", label: "انواع تسویه", icon: Wallet, module: "pricing", group: "admin", subgroup: "adm-settings", adminOnly: true },
  { to: "/pricing/shipping-rules", label: "قوانین ارسال", icon: Workflow, module: "pricing", group: "admin", subgroup: "adm-settings", adminOnly: true },
  ...
  { to: "/admin/automation", label: "اتوماسیون فاز صفر", icon: Sparkles, module: "roles", group: "admin", subgroup: "adm-tools", adminOnly: true },
  ...
  { to: "/gamification/admin/leagues", label: "مدیریت لیگ‌ها", icon: Trophy, module: "roles", group: "admin", subgroup: "adm-gamification", adminOnly: true },
  { to: "/gamification/admin/rewards", label: "مدیریت پاداش‌ها", icon: Trophy, module: "roles", group: "admin", subgroup: "adm-gamification", adminOnly: true },
  { to: "/gamification/admin/analytics", label: "تحلیل گیمیفیکیشن", icon: BarChart3, module: "roles", group: "admin", subgroup: "adm-gamification", adminOnly: true },
  { to: "/gamification/admin/purchase-settings", label: "طلای زمان (خرید)", icon: Coins, module: "roles", group: "admin", subgroup: "adm-gamification", adminOnly: true },
];
