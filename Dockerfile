...
ARG VITE_SHOW_ENVIRONMENT_BANNER
ARG VITE_ENVIRONMENT_BANNER_TEXT
ENV VITE_SUPABASE_URL=$VITE_SUPABASE_URL \
    VITE_SUPABASE_PUBLISHABLE_KEY=$VITE_SUPABASE_PUBLISHABLE_KEY \
    VITE_SUPABASE_PROJECT_ID=$VITE_SUPABASE_PROJECT_ID \
    VITE_APP_ENV=$VITE_APP_ENV \
    VITE_ENVIRONMENT_NAME=$VITE_ENVIRONMENT_NAME \
    VITE_SHOW_ENVIRONMENT_BANNER=$VITE_SHOW_ENVIRONMENT_BANNER \
    VITE_ENVIRONMENT_BANNER_TEXT=$VITE_ENVIRONMENT_BANNER_TEXT \
    NODE_ENV=production \
    SELF_HOST_NODE=1
