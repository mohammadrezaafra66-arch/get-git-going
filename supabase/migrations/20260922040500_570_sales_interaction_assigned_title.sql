...
-- ============================================================================
-- 570 - notify_sales_interaction_assigned title → «من مسئول شدم» (C4)
-- ============================================================================
-- Prior live def saved to evidence/W3/notify_assigned_before.sql.
-- Title only change via Unicode escape. Fire rules unchanged.
--
-- Rollback: docs/missions/salesdesk-9-fixes/revert/570_sales_interaction_assigned_title.sql
-- ============================================================================
...
COMMENT ON FUNCTION public.notify_sales_interaction_assigned() IS
  'Enqueues notification_queue row when sales_interactions.salesperson_id is set/changed. Title changed in migration 570.';
