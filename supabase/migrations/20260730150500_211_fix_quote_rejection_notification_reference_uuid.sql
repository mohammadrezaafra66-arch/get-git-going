...
-- ============================================================================
-- 211/216 — Fix quote rejection notification reference_id type.
-- ============================================================================
-- Root cause:
--   public.notification_queue.reference_id is uuid, and p_quote_id is already
--   uuid, but migration 20260729143000_224_quote_rejection_notification.sql
--   inserted p_quote_id::text into reference_id. Postgres rejected the insert:
--     column "reference_id" is of type uuid but expression is of type text
--
-- Scope:
--   Recreate only public.update_sales_quote_status with the same behavior and
--   the uuid-safe reference_id expression. No table/constraint/business-rule
--   changes.
--
-- Rollback:
--   Re-apply the previous function body from
--   20260729143000_224_quote_rejection_notification.sql.
-- ============================================================================
