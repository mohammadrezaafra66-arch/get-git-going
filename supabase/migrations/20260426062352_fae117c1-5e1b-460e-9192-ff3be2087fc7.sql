DROP FUNCTION IF EXISTS public.import_dynamic_table_rows(uuid, jsonb);
...
GRANT EXECUTE ON FUNCTION public.import_dynamic_table_rows(uuid, jsonb, uuid) TO authenticated;