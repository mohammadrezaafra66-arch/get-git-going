...
BEGIN
  ...
  v_result := jsonb_build_object(
    ...
    'weighted_score',        CASE WHEN v_params_evaluated = 0 THEN NULL ELSE ROUND(v_weighted_score::numeric,6) END,
    'total_weight_used',     ROUND(v_total_active_weight::numeric,6),
