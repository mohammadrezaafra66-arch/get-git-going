...
REVOKE ALL ON FUNCTION public.get_customer_dynamic_credit(uuid) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.get_customer_dynamic_credit(uuid) TO authenticated;
